    ...
    <main className="flex min-h-screen items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-3 text-muted-foreground">
          <p>
            Your account has been <strong>permanently</strong> banned due to a violation of our terms of service.
          </p>
          <p>
            This ban is permanent and can only be lifted by an administrator.
